...
# Generate a synthetic dataset using marginal distributions and the Cramer's V matrix from Berg et al. (2020).
# 
# 
...
# Apply precise calibration to reach exactly 1.0% default rate
TARGET_DEFAULT_RATE = 0.01  # 1.0% default rate for scorable population
...
# Check if we need further adjustment to hit exactly 1.0%
...
# 
# Assign TARGET with precise control to match exactly 1.0% default rate
# 
...
categorical_columns = [
    "credit_score_quintile", "device_type", "os", "email_host", "channel", "checkout_time",
    "name_in_email", "number_in_email", "is_lowercase", "email_error",
    "age_quintile", "order_amount_quintile", "item_category", "month", "gender", "TARGET"
]
# Include TARGET for conditional generation
...
# 
# Generate synthetic data with controlled default rate, fixing it at exactly 1.0% for the scorable population.
# 
